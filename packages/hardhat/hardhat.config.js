...
// const INFURA_ID = '7bfdc64f49e146d99c2794da8b243bba'
...
module.exports = {
  ...
  networks: {
    hardhat: {
      accounts: generateAccounts(5000)
    },
    localhost: {
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/7bfdc64f49e146d99c2794da8b243bba",
      accounts: {
        mnemonic: mnemonic(),
      },
    },
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/7bfdc64f49e146d99c2794da8b243bba",
      accounts: {
        mnemonic: mnemonic(),
      },
    },
