...
contract TenKLosersDev is Ownable, ERC721Enumerable {

    uint public constant MAX_NFTS = 10000;
    uint private NFT_PRICE = 0.1 ether;
    uint private walletLimit = 5;
        ...
        // PaymentSplitter(team, team_shares)
    {
        ...
        accounts[msg.sender] = Account( 190, 0, 0, true, true, true);
    ...
    function airDropMany(address[] memory _addr) external onlyAdmin {
        require(totalSupply() + _addr.length <= MAX_WIVES, "You would exceed the limit");
